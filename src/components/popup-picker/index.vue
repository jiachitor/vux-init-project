    ...
    <div v-transfer-dom="isTransferDom">
        <popup v-model="showValue" class="vux-popup-picker" :id="`vux-popup-picker-${uuid}`" @on-hide="onPopupHide" @on-show="onPopupShow" :popup-style="popupStyle">
            <div class="vux-popup-picker-container">
                <popup-header :left-text="cancelText || $t('cancel_text')" :right-text="confirmText || $t('confirm_text')" @on-click-left="onHide(false)" @on-click-right="onHide(true)" :title="popupTitle"></popup-header>
