...
.vux-table.vux-table-no-cell-bordered td,
.vux-table.vux-table-no-cell-bordered th {
    &:after {
        border-right-width: 0;
    }
}

.vux-table tr td:last-child,
.vux-table tr th:last-child {
    &:after {
        border-right-width: 0;
    }
}

.vux-table.vux-table-bordered tr td:last-child,
.vux-table.vux-table-bordered tr th:last-child {
    &:after {
