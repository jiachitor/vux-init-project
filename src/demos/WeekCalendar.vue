<template>
<div>
    <week-calendar v-model="value" ref="calendar" :marks="marks" @on-view-change="onWeekViewChange" @on-year-month-change="onYearMonthChange">
    ...
    <inline-calendar v-model="value" :marks="marks" ref="inlineCalendar" @on-view-change="onViewChange"></inline-calendar>
